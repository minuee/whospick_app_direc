...
import {changeTime, isEmptyArr} from '../../../common/Utils';
...
const QnA = props => {
  ...
  const _getMyQnAList = async bool => {
    ...
    try {
      ...
      console.log('_getMyQnAList -> error', error);
  ...
  return (
    <View style={{...styles.container}}>
      <Header
        ...
        rightComponent={
          <TouchableOpacity
            onPress={() => props.navigation.navigate('QnAWrite', {SET_DATA_LIST: setDataList, DATA_LIST: dataList})}>
