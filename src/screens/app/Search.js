...
import {isEmpty, isEmptyArr, YYYYMMDD} from '../../common/Utils';
...
const Search = props => {
  ...
  const _onSearchPress = async () => {
    ...
    try {
      ...
      console.log('_onSearchPress -> error', error);
          ...
          <View style={{...styles.viewInner}}>
            ...
            {!isEmptyArr(dataList.affiliate) && (
              <View style={{...styles.viewAuditionArea}}>
                ...
                <TouchableOpacity
                  onPress={() => props.navigation.navigate('SearchList', {TYPE: 'PARTNER', SEARCH_TEXT: searchText})}>
                  <Text style={{...styles.txtViewMore}}>{'View More >'}</Text>
                </TouchableOpacity>
              </View>
            )}
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      props.navigation.navigate('PartnerDetail', {
                        partnerType: item.affiliate_category_text,
                        title: item.title,
            ...
            {!isEmptyArr(dataList.audition) && (
              <View style={{...styles.viewAuditionArea}}>
                ...
                <TouchableOpacity
                  onPress={() => props.navigation.navigate('SearchList', {TYPE: 'AUDITION', SEARCH_TEXT: searchText})}>
                  <Text style={{...styles.txtViewMore}}>{'View More >'}</Text>
                </TouchableOpacity>
              </View>
            )}
