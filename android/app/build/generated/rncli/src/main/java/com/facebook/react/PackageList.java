...
public class PackageList {
  ...
  public ArrayList<ReactPackage> getPackages() {
    return new ArrayList<>(Arrays.<ReactPackage>asList(
      ...
      new CodePush(getResources().getString(com.whospick.director.app.R.string.CodePushDeploymentKey), getApplicationContext(), com.whospick.director.app.BuildConfig.DEBUG),
